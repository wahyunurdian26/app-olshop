    ...
    <footer class="bg-gray-800 text-white pt-12 pb-6">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <!-- About -->
          <div>
            <h3 class="text-xl font-bold mb-4">MyShop</h3>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><NuxtLink to="/products" class="text-gray-400 hover:text-white">Products</NuxtLink></li>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><NuxtLink to="/shipping" class="text-gray-400 hover:text-white">Shipping Policy</NuxtLink></li>
              <li><NuxtLink to="/returns" class="text-gray-400 hover:text-white">Return Policy</NuxtLink></li>
              <li><NuxtLink to="/privacy" class="text-gray-400 hover:text-white">Privacy Policy</NuxtLink></li>
              <li><NuxtLink to="/terms" class="text-gray-400 hover:text-white">Terms & Conditions</NuxtLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form class="flex">
              <input 
                ...
                class="px-4 py-2 w-full rounded-l focus:outline-none text-gray-800"
                required
              >
              <button 
                type="submit" 
